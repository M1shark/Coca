...
const insightSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".insight-slider__content", {
  navigation: {
...
const testimonialsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".testimonials-slider__content", {
  slidesPerView: "auto",
  navigation: {
    nextEl: ".testimonials-slider__btn-item--next",
    prevEl: ".testimonials-slider__btn-item--prev"
  }
});
const attractionSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".attraction-slider__content", {
  loop: true,
  navigation: {
    nextEl: ".attraction-slider__btn--next",
    prevEl: ".attraction-slider__btn--prev"
  },
  breakpoints: {
    320: {
      slidesPerView: 1,
...
const blogSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".blog-slider__content", {
  loop: true,
  breakpoints: {
    320: {
      slidesPerView: 1.25,
